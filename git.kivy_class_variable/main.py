...
class fscreen(Widget):
	...
	def change_color(self):
		theapp.secscreen.ids.lb.color = [1, 0, 0,1]
		theapp.secscreen.ids.lb.text = 'color has been changed'
...
class secscreen(Widget):
	...
	def change_color(self):
		theapp.fscreen.ids.lb.color = [1, 0, 0,1]
		theapp.fscreen.ids.lb.text = 'color has been changed'
